...
public class AutoFillTextBoxSkin<T> extends SkinBase<AutoFillTextBox<T>,AutoFillTextBoxBehavior<T>> 
    ...
    //This is Button where user clicks for list
    private Node down;
    ...
    public void skinArrow(final Rectangle rect){
    	
    	StackPane pane = ((StackPane)down);
        ...
        polygon.setFill(Color.web("#b4b4b4"));
        InnerShadow is = new InnerShadow();
        
        is.setOffsetX(4.0);
        is.setOffsetY(4.0);
        is.setColor(Color.GRAY);
        polygon.setEffect(is);
        ...
        pane.getChildren().addAll(rect,polygon);
        pane.setMaxWidth(25);
    ...
    public AutoFillTextBoxSkin(AutoFillTextBox text){
        ...
        textbox.heightProperty().addListener(new ChangeListener<Number>(){
			...
			public void changed(ObservableValue<? extends Number> arg0,
				...
				rect.setHeight(arg2.doubleValue()-5);				
			}
        	
        });
        /*down.widthProperty().addListener(new ChangeListener<Number>(){

			@Override
			public void changed(ObservableValue<? extends Number> arg0,
					Number arg1, Number arg2) {
				//down.setTranslateX(arg2.doubleValue());
...
//        FXCollections.sort(data);
        ...
        down.visibleProperty().bind(listview.visibleProperty());
        setAlignment(textbox, Pos.CENTER_LEFT);
        setAlignment(down, Pos.CENTER_RIGHT);
        getChildren().addAll(textbox,down);
    ...
    public void showPopup(){
        listview.setPrefWidth(textbox.getWidth());
         ...
         popup.show(
                 ...
                 getWindow().getY()+textbox.localToScene(0,0).getY()+ textbox.getScene().getY()+TITLE_HEIGHT-5); 
